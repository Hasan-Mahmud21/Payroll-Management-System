...
<body>
    ...
    <form action="../control/reg_control.php" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <fieldset>
            ...
            <input type="file" id="profile_picture" name="profile_picture" value="<?= $oldData['profile_picture'] ?? '' ?>">
        ...
        <fieldset>
            ...
            <span class="error-message"><?= $errors['f_name'] ?? '' ?></span><br><br>
            ...
            <span class="error-message"><?= $errors['e_name'] ?? '' ?></span><br><br>
            ...
            <span class="error-message"><?= $errors['emprole'] ?? '' ?></span><br><br>
        </fieldset>
