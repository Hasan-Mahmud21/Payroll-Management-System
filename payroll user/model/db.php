...
class myDB {
    ...
    public function openCon() {
        ...
        $DBName = "payrolldb"; // Database name
    ...
    public function updateDataUser($connectionObject, $tableName, $id, $user_id, $basic_salary, $bonus, $deduction, $payment_date) {
        ...
        $stmt->bind_param("ssssss", $user_id, $basic_salary, $bonus, $deduction, $payment_date, $id);
        if ($stmt->execute()) {
            $stmt->close();
...
// Update a record
echo $db->updateDataUser($conn, 'payroll', 102, 105, 40000, 3000, 2000, '2025-04-01') . "<br>";

// Delete a record
echo $db->deleteData(104, 'payroll', $conn) . "<br>";
